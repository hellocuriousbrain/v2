      ...
      <!-- ################################################################################################ -->
        ...
        <?php
            ...
            <div class="borderedbox_quotes">
                ...
                <a href="../../../../author/<?php echo $authorId ?>/quotes/<?php echo $i ?>/<?php echo $authorId ?>.php"><img class="imgl borderedbox inspace-5" src="../../../data/images/author/<?php echo $authorId ?>/quotes/<?php echo $i ?>/<?php echo $authorId ?>-Quotes.jpg" alt=""></a>
