...
<html>
<head>
<?php include "./../../data/title/courses/hindi/title_".$currpageId.".php" ?>
...
<?php 
    include "../../data/page_cover/courses/hindi/page_cover_".$currpageId.".php";
...
<?php include "../../data/sub_page_content/courses/hindi/sub_page_content_".$currpageId.".php" ?>
