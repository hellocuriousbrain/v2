...
<html>
<head>
<?php include "./../../../data/metadata/courses/$currentCourseName/$currentChapterName/metadata_".$currpageId.".php"; 
metadata($currentCourseName,$currentChapterName, $currpageId)
?>
...
<?php include "../../../data/sub_page_content/courses/$currentCourseName/$currentChapterName/sub_page_content_".$currpageId.".php" ?>
