...
function page_cover_fun($currentCourseName,$currentChapterName, $currentType, $currentLessonNumber, $currpageId) {
  ...
  <div id="breadcrumb" class="hoc clear"> 
    ...
    <ul>
      ...
      <li><a href="../../../../../courses/english/cursive-handwriting/alphabet-sequence/lesson-5/cursive-handwriting-capital-letters-j-r.php">cursive handwriting lesson#1</a></li>
    </ul>
    <!-- ################################################################################################ -->
  </div>
</div>
