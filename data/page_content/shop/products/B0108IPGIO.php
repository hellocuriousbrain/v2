...
<div class="wrapper row3 ">
  <main class="hoc container clear"> 
    ...
    <h2> Pilot V7 Hi-tecpoint Pen with cartridge system  </h2> 
      <!-- ############################################################################################### -->
        <!-- Slider div Starts-->
        ...
        <!-- Loading Screen -->
            ...
            <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:440px;height:420px;overflow:hidden;">
                <div data-p="170.00">
                     <img data-u="image" src="../../data/images/shop/products/B0108IPGIO/1.jpg" />
                     <img data-u="thumb" src="../../data/images/shop/products/B0108IPGIO/1-thumb.jpg" />
                </div>
                <div data-p="170.00">
                    <img data-u="image" src="../../data/images/shop/products/B0108IPGIO/2.jpg" />
                    <img data-u="thumb" src="../../data/images/shop/products/B0108IPGIO/2-thumb.jpg" />
                </div>
                <div data-p="170.00">
                    <img data-u="image" src="../../data/images/shop/products/B0108IPGIO/3.jpg" />
                    <img data-u="thumb" src="../../data/images/shop/products/B0108IPGIO/3-thumb.jpg" />
                </div>
                <div data-p="170.00">
                    <img data-u="image" src="../../data/images/shop/products/B0108IPGIO/4.jpg" />
                    <img data-u="thumb" src="../../data/images/shop/products/B0108IPGIO/4-thumb.jpg" />
                </div>
                <div data-p="170.00">
                    <img data-u="image" src="../../data/images/shop/products/B0108IPGIO/5.jpg" />
                    <img data-u="thumb" src="../../data/images/shop/products/B0108IPGIO/5-thumb.jpg" />
                </div>
            </div>
        <!-- Thumbnail Navigator -->
...
<a href="https://amzn.to/2z6K0Ho" target="_blank" ><img class="btmspace-30" src="../../data/images/buy-now-amazon.png" alt=""></a>
...
<br>
        <h2>Key Feature</h2>
<ul class="KeyFeature">
        <li > For the first time! Pilot V7 Tecpoint Pen comes with rechargeable cartridge system </li>
        <li> 4 V7 cartridges with this special pack  </li>
        <li> Ideal for school and college students </li>
        <li> Writes twice as much as a gel pen </li>
      </ul>
<br>
        <h2>Offers</h2>
      <p>
